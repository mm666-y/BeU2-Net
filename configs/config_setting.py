...
class setting_config:
    ...
    datasets = 'adamW_V9T10'
    data_path = '/home/ubuntu/datasets/private_A4C/A4C_label_all_250/'
    ...
    criterion_seg = nDiceLoss(n_classes = num_classes)
    ...
    frame_transformer = transforms.Compose([
        imgToTensor(),
    ])
